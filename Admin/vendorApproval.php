...
<div x-data="multipleTable">
    ...
    $query = "SELECT * FROM vendor WHERE vendorStatus = 'Pending'";
    ...
    while($infoPending=mysqli_fetch_array($pendingVendor)) {
        ...
        <tr>
            ...
            <td>
            <span class="badge <?php echo ($vendorStatus == 'pending') ? 'bg-warning' : 'bg-warning'; ?>">
            <?php echo ($vendorStatus == 'pending') ? 'Pending' : 'Pending' ; ?>
    </span>
            </td>
            <td>
